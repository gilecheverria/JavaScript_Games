/*
 * Character class, inherits from AnimatedObject.
 * This is the base class for all characters in the game,
 * including the player and enemies.
 *
 * The position of the character is its center.
 * The collider is also centered on the character, and its size is determined
 * by the width and height parameters in the constructor.
 *
 * The character has HP and can take damage. When taking damage, it will trigger
 * a hit animation that makes the character flash red.
 *
 * Gilberto Echeverria
 * 2026-02-25
 */
...
export class Character extends AnimatedObject {
    constructor( { position, width, height, color, type } ) {
        ...
        this.tempCanvas.width = this.size.x * this.scale;
        this.tempCanvas.height = this.size.y * this.scale;
