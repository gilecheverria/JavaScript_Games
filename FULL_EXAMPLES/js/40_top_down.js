...
import { Level } from "./libs/Level";
import { TextLabel } from "./libs/TextLabel.js";
import { LEVEL_CHARS, GAME_LEVELS } from "./41_levels.js";
...
class Game {
    ...
    addBullet(destinationX, destinationY) {
        let item = LEVEL_CHARS["B"];
        const bullet = new Bullet( {
            position: new Vector(game.player.position.x, game.player.position.y),
            width: 1,
            height: 1,
            color: "red",
            type: item.label
