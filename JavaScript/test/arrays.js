...
describe("Array Module Tests", () => {
    ...
    describe("addItemsReduce", () => {
        it("empty array", () => {
            deepStrictEqual(arr.addItemsReduce([]), 0);
        });

        it("one item array", () => {
            deepStrictEqual(arr.addItemsReduce([5]), 5);
        });

        it("two item array", () => {
            deepStrictEqual(arr.addItemsReduce([5, 8]), 13);
        });

        it("three item array", () => {
            deepStrictEqual(arr.addItemsReduce([5, 8, 2]), 15);
        });

        it("multiple item array", () => {
            deepStrictEqual(arr.addItemsReduce([5, 8, 2, 4, 6]), 25);
        });
    });
